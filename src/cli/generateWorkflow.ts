...
export interface GenerateWorkflowOptions {
  ...
  ai?: boolean;
  model?: string;
  /** When true, do not prompt before overwriting .cursor/; implies full refresh */
  skipConfirm?: boolean;
}

/**
 * Full analyze + generate pipeline for `generate` and `rsync` commands.
 */
export async function runGenerateWorkflow(
  ...
  try {
    ...
    console.log("  - .cursor/automations/ (4 automation workflows)");
    console.log("  - .cursor/CURSOR_README.md");
